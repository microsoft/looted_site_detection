...
try:
    from .config import PLANETSCOPE_MEAN, PLANETSCOPE_STD
except ImportError:
    from looted_site_detection.config import PLANETSCOPE_MEAN, PLANETSCOPE_STD
...
class ImageDataset(Dataset):
    ...
    def _setup_transforms(self):
        ...
        mean = [v / 255.0 for v in PLANETSCOPE_MEAN]
        std = [v / 255.0 for v in PLANETSCOPE_STD]
